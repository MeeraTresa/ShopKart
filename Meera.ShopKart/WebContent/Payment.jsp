...
<table>
<tr><td>Name :</td><td><input type = "text" id="dname" name = "dname" ></td></tr>
<tr><td>Delivery address : </td><td><textarea id="dadd"  name ="dadd" rows=4 cols=17></textarea></td></tr>
<tr><td>Contact Number :</td><td><input type="text" id="dphone" onkeypress="return isNumberKey(event)"></td></tr>
</table>
